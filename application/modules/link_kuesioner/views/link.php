                                        ...
                                        <tbody>
                                             ...
                                             <tr class="fw-normal">
                                                  ...
                                                  <td>
                                                       ...
                                                       <input value="<?php echo $d->nama_paket; ?>" name="<?php echo "nama_kuesioner" . $d->id_soal; ?>"  hidden />
                                                        <input value="<?php echo $d->responden; ?>" name="<?php echo "responden" . $d->id_soal; ?>" hidden />
                                                       <input value="<?php echo base_url('kuesioner/form/') . enkrip($d->id_paket); ?>" name="<?php echo "link_kuesioner" . $d->id_soal; ?>" hidden />
