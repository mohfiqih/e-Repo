...
<body style="background-color: white;!important">
     <div class="content" style="margin-left: 20px;margin-right: 15px;margin-top: 50px;">
          <div class="container">
               <div class="row">
                    <div class="col-md-6">
                         <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgW07zhzjpZHSwn8FDBfDe9VBJtEEDZMQk-4k-l6iY2KgjfK0FOtlMo2t1TPjVZG4eZMssd9CJkhhfT2pIyPj0INTooBgTNAgAY4K253vhN_uzIvT3c35lAxIhT0ud7c2Ai8yHat-Z5VygeYPk0DBSkkVTwswbcaEX94jDjlVT8f-L2r3ktO8XlXMruhJo/s907/Desain%20tanpa%20judul.gif"
                              alt="Image" class="img-fluid" style="width: 450px;margin-top: 20px;">
                    </div>
                         ...
                         <div class="row justify-content-center">
                              <div class="col-md-8">
                                   ...
                                   <form action="auth/proses" method="POST">
                                        ...
                                        <span class="d-block text-left my-4 text-muted"> Copyright &copy; e-Repo -
                                             Moh.
                                             Fiqih Erinsyah - TI</span>
                                   </form>
                              </div>
                         </div>
                    </div>
